...
keyss = []
Ciphertext = '0b101000,0b11,0b10111000,0b1110111,0b1001101,0b10111000,0b1110111,0b11111001,0b10111000,0b110,0b1001101,0b10111000,0b1001101,0b110110,0b101000,0b110110,0b110110,0b1110111,0b101000,0b11111001,0b11111001,0b1110111,0b1001101,0b11,0b11,0b1001101,0b10111000,0b1001101,0b10100011,0b110110,0b11010111,0b10111000,0b11,0b1110111,0b11,0b10100011,0b10100011,0b101000,0b110,0b101000,0b110,0b1001101,0b1001101,0b101000,0b11,0b10111000,0b110,0b11010111,0b110,0b11111001,0b10111000,0b101000,0b10111000,0b1001101,0b10111000,0b10100011,0b110,0b11,0b10100011,0b10100011,0b11010111,0b110,0b1110111,0b1001101,0b110,0b1001101,0b11010111,0b101000,0b11111001,0b10111000,0b101000,0b110,0b1110111,0b1001101,0b110,'
for i in range(1024):
    ...
    if(binaryToDecimal(int(decrypttext[0])) == ord('5') and binaryToDecimal(int(decrypttext[1])) ==  ord('9') and binaryToDecimal(int(decrypttext[2])) == ord('0') and binaryToDecimal(int(decrypttext[3])) == ord('6') and binaryToDecimal(int(decrypttext[4])) == ord('1') and binaryToDecimal(int(decrypttext[5])) == ord('0') and binaryToDecimal(int(decrypttext[6])) == ord('6') and binaryToDecimal(int(decrypttext[7])) == ord('4') and binaryToDecimal(int(decrypttext[8])) == ord('0') ):
